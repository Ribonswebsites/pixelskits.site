...
def page_html(p):
    ...
    steps = ''.join(f'<li><strong>{i}.</strong> {step}</li>' for i, step in enumerate([f'Open the <a href="index.html">Pixelskits toolkit</a> in a modern browser.', 'Choose the tool that matches your task and select a file or enter your content.', 'Adjust the available settings and review the result before saving it.', 'Download the finished file to your device.'], 1))
    faq = f'<h2>Frequently asked questions</h2><h3>Is {p["h1"].lower()} free?</h3><p>Yes. The {p["h1"].lower()} workflow is available at no cost on Pixelskits and does not require an account.</p><h3>Do I need to install software?</h3><p>No. Pixelskits is designed to work in a modern desktop or mobile browser.</p><h3>Can I use Pixelskits on a phone?</h3><p>Yes. The site is responsive, although large files may process more quickly on a desktop or laptop.</p>'
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{p['title']}</title><meta name="description" content="{p['description']}"><meta name="keywords" content="{p['keywords']}"><meta name="author" content="Ribon Patil"><meta name="robots" content="index,follow,max-image-preview:large"><link rel="canonical" href="{canonical}"><link rel="sitemap" type="application/xml" href="/sitemap.xml"><meta property="og:type" content="website"><meta property="og:site_name" content="Pixelskits"><meta property="og:title" content="{p['title']}"><meta property="og:description" content="{p['description']}"><meta property="og:url" content="{canonical}"><meta property="og:image" content="https://pixelskits.site/og-image.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="{p['title']}"><meta name="twitter:description" content="{p['description']}"><meta name="twitter:image" content="https://pixelskits.site/og-image.png"><script type="application/ld+json">{json.dumps(schema, ensure_ascii=False)}</script><style>{style}</style></head><body><header class="top"><div class="wrap"><a class="brand" href="index.html">Pixels<span>kits</span></a><nav><a href="index.html">All tools</a><a href="contact.html">Contact</a><a href="privacy.html">Privacy</a></nav></div></header><main><div class="wrap"><section class="hero"><div class="eyebrow">{p['eyebrow']} · PIXELSKITS</div><h1>{p['h1']}</h1><p>{p['intro']}</p><img src="og-image.png" width="1200" height="630" loading="eager" alt="Pixelskits free online image and PDF tools" style="display:block;width:100%;max-width:780px;height:auto;border-radius:18px;margin:28px 0;border:1px solid #2a3047"><a class="button" href="index.html#features">Open Pixelskits tools</a></section><section class="grid"><article class="card"><h2>What you can do</h2><ul>{lis}</ul></article><article class="card"><h2>How to use this tool</h2><ol>{steps}</ol></article></section><section class="card"><h2>Private browser-based processing</h2><p>Pixelskits is built for quick everyday work with images, PDFs, and creator graphics. There is no account, subscription, or installation. Where a tool is browser-based, your file is processed on your device rather than uploaded as a routine step.</p><p>Use the focused guide above to understand the task, then open the toolkit and choose the matching feature. Always review the result before sharing or publishing it.</p></section><section class="card" style="margin-top:18px">{faq}</section><section class="related"><h2>Explore more Pixelskits tools</h2>{related}</section></div></main><footer><div class="wrap"><strong>Pixelskits</strong> — free image, PDF, photo, and creator tools. <a href="index.html">Return to the Pixelskits home page</a>.</div></footer></body></html>'''
